    ...
    fn item(
        ...
        Ok(match item {
            ...
            target::Item::Preamble => {
                writeln!(
                    out,
                    "# Code generated by jetted for Ruby v{}",
...
fn doc(ident: usize, s: &str) -> String {
    ...
    jetted_core::target::fmt::comment_block("", &format!("{}# ", prefix), "", s)
}

#[cfg(test)]
mod tests {
    mod std_tests {
        jetted_test::std_test_cases!(&crate::Target::new("JettedE2E".into()));
    }

    mod optional_std_tests {
        jetted_test::strict_std_test_case!(
            &crate::Target::new("JettedE2E".into()),
