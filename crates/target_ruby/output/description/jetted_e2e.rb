...
module JettedE2E
  ...
  class Root
    ...
    def to_json_data
      data = {}
      data["discriminator_with_description"] = JettedE2E::to_json_data(discriminator_with_description)
      data["enum_with_description"] = JettedE2E::to_json_data(enum_with_description)
      data["long_description"] = JettedE2E::to_json_data(long_description)
      data["properties_with_description"] = JettedE2E::to_json_data(properties_with_description)
      data["ref_with_description"] = JettedE2E::to_json_data(ref_with_description)
      data["string_with_description"] = JettedE2E::to_json_data(string_with_description)
      data
    end
  end
