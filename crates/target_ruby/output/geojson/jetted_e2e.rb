...
module JettedE2E
  ...
  class Geojson
    ...
    def self.from_json_data(data)
      out = Geojson.new
      out.value = JettedE2E.from_json_data(GeojsonObject, data)
      out
    end
  ...
  class BoundingBox
    ...
    def self.from_json_data(data)
      out = BoundingBox.new
      out.value = JettedE2E.from_json_data(Array[Float], data)
      out
    end
  ...
  class GeojsonObjectFeature < GeojsonObject
    ...
    def self.from_json_data(data)
      ...
      out.type = "Feature"
      out.geometry = JettedE2E::from_json_data(GeojsonObject, data["geometry"])
      out.properties = JettedE2E::from_json_data(Hash[String, Object], data["properties"])
      out.id = JettedE2E::from_json_data(Object, data["id"])
      out
    end

    def to_json_data
      data = { "type" => "Feature" }
      data["geometry"] = JettedE2E::to_json_data(geometry)
      data["properties"] = JettedE2E::to_json_data(properties)
      data["id"] = JettedE2E::to_json_data(id) unless id.nil?
      data
    end
  end
  ...
  class GeojsonObjectFeatureCollection < GeojsonObject
    ...
    def self.from_json_data(data)
      ...
      out.features = JettedE2E::from_json_data(Array[GeojsonObject], data["features"])
      out
    end

    def to_json_data
      data = { "type" => "FeatureCollection" }
      data["features"] = JettedE2E::to_json_data(features)
      data
    end
  end
  ...
  class GeojsonObjectGeometryCollection < GeojsonObject
    ...
    def self.from_json_data(data)
      ...
      out.geometries = JettedE2E::from_json_data(Array[GeojsonObject], data["geometries"])
      out.bbox = JettedE2E::from_json_data(BoundingBox, data["bbox"])
      out
    end

    def to_json_data
      data = { "type" => "GeometryCollection" }
      data["geometries"] = JettedE2E::to_json_data(geometries)
      data["bbox"] = JettedE2E::to_json_data(bbox) unless bbox.nil?
      data
    end
  end
  ...
  class GeojsonObjectLineString < GeojsonObject
    ...
    def self.from_json_data(data)
      ...
      out.type = "LineString"
      out.coordinates = JettedE2E::from_json_data(Array[Position], data["coordinates"])
      out.bbox = JettedE2E::from_json_data(BoundingBox, data["bbox"])
      out
    end
    ...
    def to_json_data
      ...
      data["coordinates"] = JettedE2E::to_json_data(coordinates)
      data["bbox"] = JettedE2E::to_json_data(bbox) unless bbox.nil?
      data
    end
  end
  ...
  class GeojsonObjectMultiPolygon < GeojsonObject
    ...
    def self.from_json_data(data)
      ...
      out.coordinates = JettedE2E::from_json_data(Array[LinearRing], data["coordinates"])
      out.bbox = JettedE2E::from_json_data(BoundingBox, data["bbox"])
      out
    end
  ...
  class GeojsonObjectPoint < GeojsonObject
    ...
    def self.from_json_data(data)
      ...
      out.type = "Point"
      out.coordinates = JettedE2E::from_json_data(Position, data["coordinates"])
      out.bbox = JettedE2E::from_json_data(BoundingBox, data["bbox"])
      out
    end
  ...
  class LinearRing
    ...
    def self.from_json_data(data)
      out = LinearRing.new
      out.value = JettedE2E.from_json_data(Array[Position], data)
      out
    end
