...
module JettedE2E
  ...
  class Root
    ...
    def self.from_json_data(data)
      ...
      out.foo1 = JettedE2E::from_json_data(String, data["_foo"])
      out.foo_bar = JettedE2E::from_json_data(String, data["foo\nbar"])
      out.foo_bar0 = JettedE2E::from_json_data(String, data["foo bar"])
      out.foo0bar = JettedE2E::from_json_data(String, data["foo0bar"])
      out.foo_bar1 = JettedE2E::from_json_data(String, data["foo﷽bar"])
      out
    end

    def to_json_data
      data = {}
      data[""] = JettedE2E::to_json_data(default_name)
      data["$foo"] = JettedE2E::to_json_data(foo)
      data["0foo"] = JettedE2E::to_json_data(foo0)
      data["_foo"] = JettedE2E::to_json_data(foo1)
      data["foo\nbar"] = JettedE2E::to_json_data(foo_bar)
      data["foo bar"] = JettedE2E::to_json_data(foo_bar0)
      data["foo0bar"] = JettedE2E::to_json_data(foo0bar)
      data["foo﷽bar"] = JettedE2E::to_json_data(foo_bar1)
      data
    end
  end
