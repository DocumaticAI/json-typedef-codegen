...
module JettedE2E
  ...
  class Root
    ...
    def self.from_json_data(data)
      ...
      out.override_type_expr = JettedE2E::from_json_data(Object, data["override_type_expr"])
      out.override_type_properties = JettedE2E::from_json_data(Object, data["override_type_properties"])
      out.override_values_container = JettedE2E::from_json_data(Hash[String, String], data["override_values_container"])
      out
    end

    def to_json_data
      data = {}
      data["override_elements_container"] = JettedE2E::to_json_data(override_elements_container)
      data["override_type_discriminator"] = JettedE2E::to_json_data(override_type_discriminator)
      data["override_type_enum"] = JettedE2E::to_json_data(override_type_enum)
      data["override_type_expr"] = JettedE2E::to_json_data(override_type_expr)
      data["override_type_properties"] = JettedE2E::to_json_data(override_type_properties)
      data["override_values_container"] = JettedE2E::to_json_data(override_values_container)
      data
    end
  end
