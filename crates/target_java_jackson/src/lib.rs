    ...
    fn item(
        ...
        Ok(match item {
            ...
            target::Item::Preamble => {
                writeln!(
                    out,
                    "// Code generated by jetted for Java + Jackson v{}",
...
fn description_with_message(
    ...
    doc(
        ...
        &format!(
            "{}\n{}",
            message,
            jetted_core::target::metadata::description(metadata)
        ),
    )
}
...
mod tests {
    mod std_tests {
        jetted_test::std_test_cases!(&crate::Target::new("com.example".into()));
    }
}
